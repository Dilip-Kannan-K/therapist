    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-full p-0 font-normal aria-selected:opacity-100 hover:bg-secondary hover:text-secondary-foreground"
        ),
        ...
        day_today: "bg-accent text-accent-foreground font-bold border-2 border-green",
        day_outside:
